  ...
  const resume = useCallback(
    async (
      ...
      await stream.submit(null, {
        ...
        // interrupt 이후 graph가 tools -> chat_model로 계속 진행될 수 있으므로
        // 최초 submit과 동일하게 model/reasoning_effort까지 포함한 full context를 다시 보냅니다.
        // LangGraph context는 run-scoped static data이고, interrupt resume은 Command(resume=...)로 이어집니다.
        // 근거:
