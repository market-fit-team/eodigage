...
// features/report의 ReportScreen을 map 도메인으로 복사한 상권 상세 화면이다.
// /map/detail 경로와 @detail 인터셉트 모달이 함께 사용한다.
type SavedReport = {
  id: string
  title: string
  date: string
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 flex items-center justify-between text-xs font-medium">
          ...
          <div className="relative flex items-center gap-2">
            ...
            <Button size="lg" onClick={() => window.print()} className="gap-1.5">
                ...
                <CardContent className="text-xs">
                  ...
                  <ul className="list-inside list-disc space-y-2 text-muted-foreground">
                    <li>
                      ...
                      : 본 구역은 서울시에 소속되어 환산보증금 상한 한도액 9억원의
                      적용을 받습니다. 임대차 보증금 비율을 산정할 때 반드시 초과
                      여부를 계산하시어 계약 갱신 보호 권리에 차질이 없도록
                      조율하시기 바랍니다.
                    </li>
                    <li>
                      <strong className="text-foreground">권리금 보호장치</strong>
                    ...
                    <li>
                      ...
                      : 중소기업벤처부 소상공인진흥공단의 분기별 저금리 융자 자금은
                      신규 매장 개설 3개월 내 사업자등록 완료 시 승인율이
                      우수합니다.
                    </li>
                  </ul>
                </CardContent>
