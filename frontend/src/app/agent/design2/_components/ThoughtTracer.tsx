...
import { Brain, ChevronDown, ChevronUp, CheckCircle2, Loader2, Sparkles } from "lucide-react"
  ...
  return (
    <div className="w-full rounded-xl border border-primary/10 bg-primary/5 p-3.5 backdrop-blur-sm transition-all duration-300">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] rounded-full bg-primary/10 px-2 py-0.5 font-mono text-primary">
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-0.5">
                      <div className="flex items-center justify-between">
                        ...
                        {step.duration && (
                          <span className="text-[9px] font-mono text-muted-foreground/60">{step.duration}</span>
                        )}
                      </div>
                      {step.details && (
