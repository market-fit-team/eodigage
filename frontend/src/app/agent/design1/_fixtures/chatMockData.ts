...
export const initialRooms: ChatRoom[] = [
  {
    ...
    updatedAt: "오전 10:30",
    lastMessage:
      "여백을 활용하는 미니멀리즘 디자인의 핵심은 본질에 집중하는 것입니다.",
  },
  {
    id: "room-2",
    ...
    updatedAt: "어제",
    lastMessage:
      "Next.js 16.2.6 버전의 변경사항에 대해 더 궁금한 점이 있으신가요?",
  },
  {
    id: "room-3",
    title: "AI 에이전트 인터페이스",
...
export const initialMessages: Record<string, ChatMessage[]> = {
  ...
  "room-2": [
    ...
    },
    {
      ...
      sender: "bot",
      content:
        "Next.js 16 버전은 Turbopack의 기본화, React 19 Server Actions의 개선, 그리고 더욱 유연해진 라우트 제어 방식을 특징으로 합니다. 특히 빌드 성능과 핫 모듈 리플레이스먼트(HMR) 속도가 비약적으로 상승했습니다.",
